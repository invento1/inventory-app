...
const navEntries: NavEntry[] = [
  ...
  { type: 'leaf', to: '/supplier-bills', label: 'Supplier Bills', icon: FileText },
  {
    ...
    children: [
      ...
      { to: '/account/receive-payment', label: 'Receive Payment' },
      { to: '/account/view-payments', label: 'View Payments' },
      { to: '/account/record-deposit', label: 'Record Deposit' },
      { to: '/account/view-deposits', label: 'View Deposits' },
      { to: '/account/pay-bills', label: 'Pay Bills' },
      { to: '/account/view-paid-bills', label: 'View Paid Bills' },
