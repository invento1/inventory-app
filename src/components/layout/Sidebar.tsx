...
export function Sidebar({ open = false, onClose }: { open?: boolean; onClose?: () => void }) {
  ...
  return (
    <aside
      className={cn(
        'fixed inset-y-0 left-0 z-40 flex h-svh w-64 shrink-0 flex-col border-r border-border bg-surface transition-transform duration-200 lg:relative lg:z-10 lg:w-60 lg:translate-x-0 lg:bg-surface/45 lg:backdrop-blur-md print:hidden',
