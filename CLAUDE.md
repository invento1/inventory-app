...
Status: Phase 1 (core inventory + walk-in sales), Phase 2 (invoicing/AR), Phase 3 (Settings + master data), and Phase 4 (double-entry ledger — Stage 1: Chart of Accounts + General Journal; Stage 2: Supplier Bills, Customer/Supplier Payment, Banking, and auto-posting; Stage 3: Undeposited Funds workflow — Receive Payment/View Payments/Record Deposit/View Deposits, and Pay Bills/View Paid Bills) are all shipped and tested. This document is the source of truth for architecture decisions, so later sessions build consistently instead of re-deriving them.
